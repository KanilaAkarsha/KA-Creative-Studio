            ...
            {user ? (
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl dark:bg-white/5 bg-black/5 dark:text-txt-primary text-txt-dark text-sm font-semibold transition-all duration-300 hover:bg-primary/10"
                >
